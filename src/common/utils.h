...
/**
 * Appends a string to a filepath, separated by '-', and keeping '.txt' at the end.
 * Generally, filepaths should be in format <filepath>-<primary_index>-<group_index>-<secondary_index>.txt
 * Primary index is generally the id of the virtual worker that processed this task.
 * Secondary index is used only to split files by keys betweem mappers and reducers.
*/
...
/**
 * Returns original filepath from a filepath generated by combine_filepath with hash 
 * generated by get_random_string().
*/
